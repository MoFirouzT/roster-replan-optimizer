...
| [`model-cache.md`](model-cache.md) | Per-tenant compiled-model caching, as [`service.md`](../specs/service.md) asks for | **0 hits in 144 solves** — a replan changes the model's own inputs. Profiling redirected the work |
