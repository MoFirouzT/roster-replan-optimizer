...
| `warm-start.md` | Speedup from hinting the previous solution, isolated from the objective effect | `[TODO — T2]` |
...
| `time-budget.md` | Solution quality at 1s / 5s / 30s | `[TODO — T2]` |
