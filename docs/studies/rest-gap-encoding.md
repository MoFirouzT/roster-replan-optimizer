...
**The two percentages are on different bases, and that is what decides the total.** 12% of a ~7 ms
build is about 0.8 ms saved; 16% of a ~3 ms search is about 0.5 ms lost. The saving is the larger
