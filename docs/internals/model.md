...
What it may hold is fixed by the independence rule ([`D-038`](../archive/decisions.md#d-038)):
...
> Thousands of near-identical columns create exactly the symmetry this model turns out not to have. [`pattern-encoding.md`](../archive/studies/pattern-encoding.md)
...
[`disruption-metrics.md`](../archive/studies/disruption-metrics.md)
...
[`regular-constraint.md`](../archive/studies/regular-constraint.md)
...
The largest single win is memoising `Instance.window`. [`presolve.md`](../archive/studies/presolve.md)
...
[`symmetry-breaking.md`](../archive/studies/symmetry-breaking.md)
...
[`reproducibility.md`](../archive/studies/reproducibility.md)
...
[`studies/`](../archive/studies/README.md).*
