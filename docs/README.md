...
| [`decisions.md`](decisions.md) | 150 numbered records: what was chosen, what was rejected, why. Enter by [ID](decisions.md#lookup), or [by theme](decisions.md#by-theme) for the records that make one argument together |
