...
REPO_VOCABULARY = {
    ...
    "infeasibility", "interchangeable", "measurable", "measurably", "plausibility",
    "portability", "portable", "probably", "reachability", "reachable", "readability",
    "readable", "reasonable", "relaxable", "reliably", "removable", "replayable",
    "reportable", "representable", "retrievability",
